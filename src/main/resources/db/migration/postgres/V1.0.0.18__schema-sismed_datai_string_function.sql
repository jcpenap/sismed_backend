...
CREATE OR REPLACE FUNCTION sismed.sismed_detail_string(
	initial_date_str varchar,
	finish_date_str varchar,
...
DECLARE
    v_initial_date date := CAST(initial_date_str AS DATE); 
	v_finish_date date := CAST(finish_date_str AS DATE ); 
